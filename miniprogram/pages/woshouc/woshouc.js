// pages/woshouc/woshouc.js
const app = getApp()
const db = wx.cloud.database()
const circle=db.collection('shouchang')
Page({
  data: {
    circle:[],
    nickname:[],
...
    jobId: '',
  ...
  // 然后通过查询记录id删除掉数据库中的这条记录
     db.collection('shouchang').doc(good_id).remove({
